...
const moduleRoutes: Record<string, { label: string; to: string }> = {
  ...
  "Time and Attendance": { label: "Open Attendance", to: "/attendance" },
  "Workforce Management": { label: "Open Attendance", to: "/attendance" },
  "Payroll and Expense": { label: "Open Payroll", to: "/payroll" },
  "Payroll and Compliance": { label: "Open Payroll", to: "/payroll" },
  "Recruitment": { label: "Open Recruitment", to: "/recruitment" },
  "Recruitment and Talent Acquisition": { label: "Open Recruitment", to: "/recruitment" },
  "Onboarding": { label: "Open Onboarding", to: "/onboarding" },
  "Documents": { label: "Open Documents", to: "/documents" },
  "Performance": { label: "Open Performance", to: "/performance" },
  "Employee Self Service": { label: "Open Profile", to: "/profile" },
  "Employee Experience": { label: "Open Helpdesk", to: "/helpdesk" },
  "Employee Service Delivery": { label: "Open Helpdesk", to: "/helpdesk" },
  "Assets and Travel": { label: "Open Assets", to: "/assets" },
  "Learning and Development": { label: "Open Performance", to: "/performance" },
  "Reports and Analytics": { label: "Open Reports", to: "/reports" },
  "Business Performance": { label: "Open Performance", to: "/performance" },
  "Employee Performance": { label: "Open Performance", to: "/performance" },
  "Workflow Automation": { label: "Open Settings", to: "/settings" },
  "Workforce Planning": { label: "Open Reports", to: "/reports" },
  "Skills and Learning Intelligence": { label: "Open Performance", to: "/performance" },
  "Compensation Management": { label: "Open Payroll", to: "/payroll" },
  "Engagement and Culture": { label: "Open Performance", to: "/performance" },
  "AI and Copilot": { label: "Open AI", to: "/ai-assistant" },
  "Integrations": { label: "Open Settings", to: "/settings" },
  "Global Core HR": { label: "Open Company", to: "/company" },
  "Benefits and Wellbeing": { label: "Open Payroll", to: "/payroll" },
  "Industrial Workforce": { label: "Open Attendance", to: "/attendance" },
  "Retail and Field Workforce": { label: "Open Attendance", to: "/attendance" },
  "BFSI and Regulated Workforce": { label: "Open Documents", to: "/documents" },
  "Healthcare Workforce": { label: "Open Employees", to: "/employees" },
  "Education Workforce": { label: "Open Employees", to: "/employees" },
  "Platform Governance": { label: "Open Settings", to: "/settings" },
  "Advanced Analytics": { label: "Open Reports", to: "/reports" },
};
